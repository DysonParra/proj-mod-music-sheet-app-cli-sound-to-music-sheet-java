...
public class MusicSheetFileWriter {
    ...
    private void createXMLFile(MusicSheet musicSheet) {
        // Crea directorio "SoundToMusicSheet".
        //File folder = new File(Environment.getExternalStorageDirectory().getPath(), ("SoundToMusicSheet")); // En android (memoria interna).
        File folder = new File(System.getProperty("user.home") + "/Desktop/SoundToMusicSheet");             // En java.
        folder.mkdir();

        // Crea directorio "Sheets" dentro del directorio "SoundToMusicSheet".
